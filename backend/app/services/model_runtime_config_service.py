    ...
    def _runtime_defaults() -> Dict[str, Dict[str, Any]]:
        return {
            ...
            "spectrum": {
                ...
                "harmonic_ratio_music": 0.6,
                "spectral_centroid_music_low": 1500,
                "spectral_centroid_music_high": 4000,
                "energy_variance_music": 0.25,
                "onset_strength_music": 0.3,
                "zcr_noise_high": 0.15,
                "zcr_variance_noise": 0.02,
                "high_freq_ratio_noise": 0.4,
                "spectral_flatness_noise": 0.5,
                "music_score_threshold": 0.35,
                "noise_score_threshold": 0.45,
                "clean_score_threshold": 0.7,
                "heavy_bgm_threshold": 0.6,
                "light_bgm_threshold": 0.35,
                "snr_high_threshold": 40.0,
                "snr_low_threshold": 25.0,
                "c50_good_threshold": 13.70,
                "c50_bad_threshold": -12.33,
                "spectral_contrast_low": 19.84,
                "spectral_contrast_critical": 13.59,
                "spectral_flatness_high": 0.29,
            },
            "smart_probe": {
                "snr_threshold": 15.0,
            },
