...
| 分类 | 数量 |
|------|------|
| bug-investigations/2025-12 | 41 |
| core-services/transcription-service | 19 |
| core-services/model-management | 16 |
| frontend-components/editor | 9 |
| bug-investigations/2026-01 | 8 |
| audio-processing/separation | 7 |
| pipeline-architecture/async-dual-pipeline | 5 |
| pipeline-architecture/preprocessing | 5 |
| core-services/confidence-system | 4 |
...
- **标题**: 预处理管道深度调查报告
- **置信度**: 🔴 32%
- **匹配原因**: demucs(22), separation(29), 分离(59)
- **目标路径**: `agent/audio-processing/separation/preprocessing-pipeline-investigation.md`
...
- **标题**: DualAlignmentPipeline vs AsyncDualPipeline 架构对比调查报告
- **置信度**: 🟢 95%
- **匹配原因**: 包含 Bug 调查关键词
- **类型**: Bug 调查
- **状态**: 未知
- **目标路径**: `agent/bug-investigations/2025-12/dual-pipeline-comparison-report.md`
...
- **类型**: Bug 调查
- **状态**: 未知
- **目标路径**: `agent/bug-investigations/2025-12/encoding_fix_checklist.md`
...
- **类型**: Bug 调查
- **状态**: 未知
- **目标路径**: `agent/bug-investigations/2025-12/encoding_issue_investigation_report.md`
...
- **类型**: Bug 调查
- **状态**: 未知
- **目标路径**: `agent/bug-investigations/2025-12/progress-update-investigation.md`
...
- **类型**: Bug 调查
- **状态**: 未知
- **目标路径**: `agent/bug-investigations/2026-01/confidence_calibration_investigation.md`
...
- **类型**: Bug 调查
- **状态**: 未知
- **目标路径**: `agent/bug-investigations/2026-01/windows_python_encoding_issues_investigation.md`
...
- **标题**: 
- **置信度**: 🔴 5%
- **匹配原因**: confidence(4), 置信度(3)
- **目标路径**: `agent/core-services/confidence-system/sensevoice_ctc_decoder_special_tags_report.md`
...
- **置信度**: 🔴 19%
- **匹配原因**: model(78), 模型(72)
- **目标路径**: `agent/core-services/model-management/whisper_model_configuration_investigation.md`
...
- **标题**: WhisperX 迁移到 Faster-Whisper 验证报告
- **置信度**: 🔴 10%
- **匹配原因**: model(14), 模型(12), manager(1)
- **目标路径**: `agent/core-services/model-management/whisperx_migration_verification_report.md`
...
- **置信度**: 🔴 3%
- **匹配原因**: model(3), 模型(1)
- **目标路径**: `agent/core-services/model-management/sensevoice-ctc-deduplication-report.md`
...
- **置信度**: 🔴 1%
- **匹配原因**: 转录(1)
- **目标路径**: `agent/core-services/transcription-service/sensevoice_ctc_decoding_process_analysis.md`
...
- **标题**: 
- **置信度**: 🔴 10%
- **匹配原因**: 文件名:frontend, editor(6), 编辑(1)
- **目标路径**: `agent/frontend-components/editor/frontend-progressbar-v35-investigation.md`
...
- **标题**: video_to_srt_gpu 旧架构残留与未迁移功能调查报告
- **置信度**: 🔴 20%
- **匹配原因**: async(4), dual(18)
- **目标路径**: `agent/pipeline-architecture/async-dual-pipeline/legacy_architecture_investigation_report.md`
...
- **标题**: 预处理直通选项调查报告
- **置信度**: 🔴 26%
- **匹配原因**: 文件名:preprocessing, preprocessing(26), 预处理(4), spectral(31)
- **目标路径**: `agent/pipeline-architecture/preprocessing/preprocessing-bypass-investigation.md`
